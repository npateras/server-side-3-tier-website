...
<html>
    ...
    <body>
        ...
        if (contentAdmins.searchShowtime(dateStartCompleted, dateEndCompleted, film_title, screen_number)) {
            errors.add(" The same showtime exists for the film " + film_title + "!");
        }
        if (contentAdmins.checkIfScreenNumberHasSpace(dateStartCompleted, dateEndCompleted, film_title, screen_number)) {
        ...
        boolean r = contentAdmins.insertShowtime(filmid, screenid, dateStartCompleted, dateEndCompleted, isavailable);
        if (r) {
            %>
